...
const ExploreCard = ({ index, active, handleClick, id, title, imgUrl}) => (
  <motion.div
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        ...
        <p className="font-normal text-[16px] leading-[20px] uppercase text-white">Enter the Metaverse</p>
        <h2 className='mt-[24px] font-semibold sm:text-[32px] text-white text-[24px]'>{title}</h2>
