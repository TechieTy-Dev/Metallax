  ...
  <div className={`${styles.innerWidth} flex flex-col gap-8 `}>
    <div className="flex items-center justify-between flex-wrap gap-5">
      ...
      <button type="button" className="flex items-center h-fit py-4 px-6 bg-[#25618b] rounded-[32px] gap-[12px]">
        ...
        <span className='font-normal text-[16px] text-white'>Enter Metallax</span>
      </button>
    </div>
    <div className="flex flex-col">
      <div className='mb-[50px] h-[2px] bg-white opacity-10' />
      <div className='flex items-center justify-between flex-wrap gap-4'>
        <h4 className='font-extrabold text-[24px] text-white uppercase'>Metallax</h4>
        <p className='font-normal text-[14px] text-white opacity-50'>Copyright &copy; 2023 Metallax. All rights reserved.</p>
