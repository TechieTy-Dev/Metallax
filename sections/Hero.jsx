  ...
  <section className={`${styles.yPaddings} pl-6 sm:pl-16`}>
    ...
    className={`${styles.innerWidth}mx-auto flex flex-col`}>
      ...
      className="relative w-full md:-mt-[20px] -mt-[12px]">
        <div className="absolute w-full h-[300px] z-0 rounded-tl-[140px] hero-gradient -top-[30px]" />
          <img className='w-full sm:h-[500px] h-[300px] rounded-tl-[140px] z-10 relative object-cover' src="/cover.png" alt="cover" />
          <a href="#explore">
